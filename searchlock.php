    ...
    <div class="bg-light text-dark" style="background-color: #1e5670;height: 320px;width: 400px;">
      <center>
        <div class="jumbotron text-center bg-primary text-white" style="background-color: #91cfc9;">
          <h4>ตรวจสอบ ค้นหารถในช่องจอดรถ</h4>
        </div>
        <p style="font-size: 14px; color: #91cfc9;">
          <input type="radio" id="checklock" name="check" checked>
          ค้นหาช่องจอกรถ
          <input type="radio" id="checklicense" name="check">
          ค้นหาจากหมายเลขทะเบียน
        </p>
        <form id="addform1">
          <div class="btn-group" id="lock">
          ...
          <div class="btn-group" style="margin-top: 5%;margin-bottom: 10%;">
