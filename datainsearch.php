...
<div class="container">
<center>   
    <div class="" style="background-color: #1e5670;height: 550px;width: 600px;" >
    <center>
      <div class="jumbotron text-center" style="background-color: #91cfc9;">
      <h3 style="color: blue;">ตรวจสอบ วัน-เวลารถเข้าทั้งหมด</h3></div>
        <form id="addform1" method="GET" action="datain.php">
          <div class="btn-group">
            <select name="day" class="btn  btn-outline-success dropdown-toggle" style="height: 50px;width:200px;margin-right: 10%;">
            ...
            <select name="month"  class="btn btn-outline-success dropdown-toggle" style="height: 50px;width:200px;">
            ...
            <br>
            <div class="btn-group">
            <select name="year" class="btn btn-outline-success dropdown-toggle" style="height: 50px;width:200px;margin-right: 10%;text-decoration-color: rgb(255, 0, 0);">
          ...
          <br>
          <select name="date" class="btn btn-outline-success dropdown-toggle" style="height: 50px;width:200px;text-decoration-color: rgb(255, 255, 255);">
          ...
          <br>
          <br>
          <input type="text" class="btn btn-outline-success" placeholder="หมายเลขทะเบียน"  name="License"style="height: 50px;width:200px;" id="License">
          <br>
          <br>
        <div class="btn-group">
